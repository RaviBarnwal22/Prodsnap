...
import { Users, BookOpen, Briefcase, MessageCircle, ArrowRight, Calendar, Clock, LayoutGrid, Newspaper } from "lucide-react"
...
export function CommunityContent({ benefits, blogPosts }: CommunityContentProps) {
    ...
    return (
        <>
            ...
            {activeTab === 'community' ? (
                ...
                <section className="py-24 px-4 bg-gray-50 dark:bg-gray-900/50 animate-in fade-in duration-500">

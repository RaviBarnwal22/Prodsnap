...
export async function evaluateAnswer(questionTitle: string, userAnswer: string): Promise<AIEvaluationResponse> {
    ...
    const prompt = PRODUCT_SENSE_PROMPT(questionTitle, userAnswer);
